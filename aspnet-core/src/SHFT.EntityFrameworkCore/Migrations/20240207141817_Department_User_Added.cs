...
{
    /// <inheritdoc />
    public partial class Department_User_Added : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppDepartmentUsers", x => new { x.UserId, x.DepartmentId });
                    table.ForeignKey(
                        name: "FK_AppDepartmentUsers_AbpUsers_UserId",
                        column: x => x.UserId,
